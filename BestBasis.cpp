...
bool** OpSet_to_MatrixF2(set<Operator64> OpSet, unsigned int m, unsigned int n)
{
  uint64_t Op = 0;
...
MatrixF2 OpSet_to_MatrixF2_Mat(set<Operator64> OpSet, unsigned int m, unsigned int n)
{
  uint64_t Op = 0;
...
/*********************************   REFILL   *********************************/
/******************************************************************************/
void OpSet_to_MatrixF2_Refill_Mat(MatrixF2 *Mat, vector<Operator64> BestBasis, set<Operator64> OpSet, unsigned int m)
...
vector<Operator64> Best_Basis_inOpSet_F2_Mat(set<Operator64> OpSet, unsigned int n, Struct_LowerBound* LowerBound, unsigned int m=1000) 
{
  vector<Operator64> BestBasis;

// ***** Initial search for best basis: ******************************
  MatrixF2 Mat = OpSet_to_MatrixF2_Mat(OpSet, m, n);
...
// ***** Refill and search for best basis: ****************************
  ...
  while( (offset < OpSet.size()) && BestBasis.size()<n && BestBasis.size()<m )
  {
    ...
    OpSet_to_MatrixF2_Refill_Mat(&Mat, BestBasis, OpSet, m);
